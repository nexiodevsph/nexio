    ...
    <div className="min-h-screen bg-slate-900 text-white flex flex-col">
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20 flex-grow">
          ...
          {projects.map((project) => (
            <div key={project.id} className="group relative bg-white/10 backdrop-blur-sm rounded-xl overflow-hidden border border-white/20 hover:border-white/40 transition-all duration-300">
              ...
              <div className="flex flex-col sm:flex-row">
                {/* Project Image */}
                <div 
                  className="relative w-full sm:w-1/3 h-48 sm:h-auto min-h-[200px] overflow-hidden bg-white/5 cursor-pointer group"
        ...
        <div className="text-center mt-16">
          <Link 
            href="/"
            className="inline-flex items-center px-8 py-3 bg-gray-700 hover:bg-gray-600 text-white rounded-md font-medium transition-colors"
          >
        ...
        >
          ...
          >
            ...
            <div className="flex items-center justify-between p-4 border-b border-white/20">
              <h3 className="text-xl font-bold text-white">{selectedProject.title} - Gallery</h3>
              <button
                onClick={closeModal}
            ...
            {/* Image Display */}
            <div className="relative flex items-center justify-center p-8 bg-black/50">
              {selectedProject.gallery.length > 1 && (
                <>
                  {/* Previous Button */}
                  <button
                    onClick={prevImage}
                    className="absolute left-4 text-white/80 hover:text-white transition-colors bg-black/50 rounded-full p-2"
                  >
                    <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  ...
                  <button
                    onClick={nextImage}
                    className="absolute right-4 text-white/80 hover:text-white transition-colors bg-black/50 rounded-full p-2"
                  >
                    <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              {/* Current Image */}
              <div className="relative max-w-4xl max-h-[60vh] w-full aspect-video bg-black/30 rounded-lg">
                <Image
            ...
            {/* Thumbnail Gallery */}
            {selectedProject.gallery.length > 1 && (
              <div className="flex gap-2 p-4 border-t border-white/20 overflow-x-auto">
